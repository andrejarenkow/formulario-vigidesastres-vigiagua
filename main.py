                ...
                for i in range(len(dados)):
                    with st.container():
                        ...
                        situacao_atualizada = st.selectbox(dados.iloc[i]['Nome da Forma de Abastecimento'],options=opcoes_situacao,
                                                           ...
                                                           key=f'situacao_{i}')
                        st.markdown(f"""
                            #root > div:nth-child(1) > div.withScreencast > div > div > div > section > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(6) > div > div > div > div.st-emotion-cache-j5r0tf.e1f1d6gn3 > div > div > div > div:nth-child(1) > div > div > div:nth-child(1) {{    
