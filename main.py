...
with container_data_editor:
    ...
    try:
        ...
        with colcenter5:
            ...
            edited_df = st.data_editor(dados_municipio[['Nome da Forma de Abastecimento','Código Forma de abastecimento','Sem informação', 'Funcionando', 'Parada/danificada']].set_index('Código Forma de abastecimento'), use_container_width=True, hide_index=True, height=(dados_municipio.shape[0]*100))  # Exibe os dados do município para edição
