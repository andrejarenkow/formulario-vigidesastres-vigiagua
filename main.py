    ...
    try:
        ...
        with colcenter5:
            ...
            if submit:
                ...
                st.markdown(f"""
                <style>
                #root > div:nth-child(1) > div.withScreencast > div > div > div > section > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(8) > div > div > div > div.st-emotion-cache-j5r0tf.e1f1d6gn3 > div > div > div > div:nth-child({str(int(quantos_selectbox+7))}) > div > div > div
                {{
                    display: flex;
                    justify-content: center; /* Centraliza horizontalmente */
                    align-items: center;
