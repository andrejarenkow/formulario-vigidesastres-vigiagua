    ...
    try:
        ...
        with colcenter5:
            edited_df = st.data_editor(dados_municipio[['Nome da Forma de Abastecimento','Código Forma de abastecimento','Situação']].set_index('Código Forma de abastecimento'),
                                       width=500, hide_index=True, column_config={"category":st.column_config.SelectboxColumn("Situação",options=['Sem informação','Funcionando','Parada/danificada'], width="medium")})
